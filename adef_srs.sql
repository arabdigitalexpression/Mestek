...
(331,1,4,'day',1,'egp',254),
(332,2,4,'day',1,'egp',545),
(333,3,4,'day',1,'egp',58),
(334,4,4,'day',1,'egp',542),
(335,5,4,'day',1,'egp',45),
(336,6,4,'day',1,'egp',575),
(337,7,4,'day',1,'egp',75),
(345,1,1,'hour',3,'egp',2424),
(346,2,1,'hour',3,'egp',242),
(347,3,1,'hour',3,'egp',2),
(348,4,1,'hour',3,'egp',42),
(349,5,1,'hour',3,'egp',242),
(350,6,1,'hour',3,'egp',4242),
(351,7,1,'hour',3,'egp',24),
(352,1,1,'hour',6,'egp',5),
(353,2,1,'hour',6,'egp',10),
(354,3,1,'hour',6,'egp',15),
(355,4,1,'hour',6,'egp',20),
(356,5,1,'hour',6,'egp',25),
(357,6,1,'hour',6,'egp',30),
(358,7,1,'hour',6,'egp',35),
(387,1,2,'hour',2,'egp',6),
(388,2,2,'hour',2,'egp',545),
(389,3,2,'hour',2,'egp',545),
(390,4,2,'hour',2,'egp',455),
(391,5,2,'hour',2,'egp',454),
(392,6,2,'hour',2,'egp',545),
(393,7,2,'hour',2,'egp',45),
(394,1,2,'hour',4,'egp',20),
(395,2,2,'hour',4,'egp',2),
(396,3,2,'hour',4,'egp',2),
(397,4,2,'hour',4,'egp',2421),
(398,5,2,'hour',4,'egp',2),
(399,6,2,'hour',4,'egp',12421),
(400,7,2,'hour',4,'egp',12312),
(401,1,2,'hour',6,'egp',51651),
(402,2,2,'hour',6,'egp',16516),
(403,3,2,'hour',6,'egp',6151),
(404,4,2,'hour',6,'egp',420),
(405,5,2,'hour',6,'egp',616516),
(406,6,2,'hour',6,'egp',260),
(407,7,2,'hour',6,'egp',616),
(408,1,2,'day',2,'egp',20),
(409,2,2,'day',2,'egp',40),
(410,3,2,'day',2,'egp',60),
(411,4,2,'day',2,'egp',70),
(412,5,2,'day',2,'egp',90),
(413,6,2,'day',2,'usd',110),
(414,7,2,'day',2,'usd',110);
...
(62,6,1,'day',2,'usd',50),
(63,7,1,'day',2,'usd',90),
(71,1,6,'hour',2,'egp',454),
(72,2,6,'hour',2,'egp',454),
(73,3,6,'hour',2,'egp',454),
(74,4,6,'hour',2,'egp',452),
(75,5,6,'hour',2,'egp',79),
(76,6,6,'hour',2,'egp',64),
(77,7,6,'hour',2,'egp',646),
(78,1,2,'trivial',1,'egp',221),
(79,2,2,'trivial',1,'egp',212),
(80,3,2,'trivial',1,'egp',2121),
(81,4,2,'trivial',1,'egp',212),
(82,5,2,'trivial',1,'egp',1212),
(83,6,2,'trivial',1,'egp',1221),
(84,7,2,'trivial',1,'egp',22121),
(85,1,3,'trivial',1,'egp',5),
(86,2,3,'trivial',1,'egp',5),
(87,3,3,'trivial',1,'egp',5),
(88,4,3,'trivial',1,'egp',5),
(89,5,3,'trivial',1,'egp',5),
(90,6,3,'trivial',1,'egp',5),
(91,7,3,'trivial',1,'egp',5),
(92,1,4,'trivial',1,'egp',20),
(93,2,4,'trivial',1,'egp',25),
(94,3,4,'trivial',1,'egp',30),
(95,4,4,'trivial',1,'egp',35),
(96,5,4,'trivial',1,'egp',40),
(97,6,4,'trivial',1,'usd',45),
(98,7,4,'trivial',1,'usd',50);
...
(37,'/uploads/tool/ed246610-bb59-11ed-8a82-54271e8cb899995644_1482693008653719_6087049128942722753_n.jpg',NULL,6);
...
(4,'16:00:00','18:00:00',3,2),
(5,'12:00:00','14:00:00',3,3),
(6,'14:00:00','16:00:00',3,3),
(13,'12:00:00','14:00:00',8,NULL),
(14,'12:00:00','14:00:00',9,NULL),
(15,'11:30:00','13:30:00',10,NULL),
(16,'11:30:00','13:30:00',11,NULL),
(17,'11:30:00','13:30:00',12,NULL),
(18,'11:30:00','13:30:00',13,NULL),
(19,'11:30:00','13:30:00',14,NULL);
...
(1,'مدى مصر','asdas da da da ','Egypt, Cairo',6,'','23546451516','hanyasser@github.com'),
(2,'أضف','مؤسسة التعبير الرقمي العربي (أضِف) ADEFمؤسسة التعبير الرقمي العربي (أضِف) ADEF ',NULL,5,'',NULL,NULL),
...
(2,'space','full_payment','451ds-d15sd-d41s5','2022-07-14 11:24:33',2,8338.24,2,NULL,'',NULL,NULL,NULL),
(3,'tool','down_payment',NULL,'2022-07-15 11:24:33',1,388.85,NULL,2,'',NULL,NULL,NULL),
(4,'space','no_payment',NULL,'2022-07-15 04:24:33',2,3873,2,NULL,'',NULL,NULL,NULL),
...
(12,'space','no_payment',NULL,'2023-03-07 23:38:20',2,1308,2,NULL,'ورشة أردوينو ',8,16,18),
(13,'space','no_payment',NULL,'2023-03-07 23:38:20',NULL,3270,2,NULL,'sdasdasd',3,3,3),
(14,'space','no_payment',NULL,'2023-03-08 11:38:23',NULL,0,1,NULL,'',0,0,0);
...
(1,'أحمد','رمضان','ramadan','askme557@gmail.com','pbkdf2:sha256:260000$9QdxVObilSi33bK1$50d05d368af305dfabaf9b2d2397d9173c3ba5ab4b7418ab587a6644d6855a45',1,5,'2022-07-30 11:11:56','+201062894694','','','2022-12-22',1,'','male',2),
(2,'يوسف','محمد','devjoe','devjoe@github.net','pbkdf2:sha256:260000$zQuiWoVfXJseAUDY$c0834e6c17ffb447ead9cba06ef8d092b6db4f1136bf40992a761ab47eef5a8f',2,6,'2022-07-30 11:11:56','+201113319016','https://www.joe.dev','Egypt, Cairo','2022-12-07',1,NULL,'male',3),
(3,'محمد ','مجدى','mmagdy','magdyos@gmail.com','pbkdf2:sha256:260000$eyRXlI4NZr902feq$60e3dd712be037c7e3b7c33cbbd382b8cd6f5a70f49f1327cdf0d877525f70cf',2,1,'2022-12-11 15:23:43','01062632649','www.magdyos.com','Egypt, Cairo','2022-12-13',0,NULL,'prefer_not_answer',NULL);
...
-- Dump completed on 2023-03-12 15:02:43
